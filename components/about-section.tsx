      ...
      <section id="about" className="min-h-screen flex items-center py-20">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            Hi, I'm Jenin — a software developer with a background in Go, C/C++, Java, and Python, currently focusing on Rust and blockchain technologies. I also have knowledge in web development (React, TypeScript), databases, cloud computing, and network security. I'm interested in building secure and reliable software systems.
            </p>
            <button
