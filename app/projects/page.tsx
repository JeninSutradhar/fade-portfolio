...
const projects = [
  {
    id: 1,
    title: "NexusCRM",
    description: "A modern B2B SaaS Customer Relationship Management platform for freelancers and small businesses. Features task tracking, client pipelines, analytics dashboard, and invoice generation.",
    category: "SaaS",
    type: "Web App",
  ...
  },
  {
    ...
    category: "Frontend",
    type: "Landing Page",
    link: "https://purplerain-test.netlify.app",
    image: "/mocks/purplerain.png"
  },
  {
    id: 3,
    title: "Fortifynet Proxy v2",
    description: "A flexible asynchronous proxy server library written in Rust, designed for performance, security, and ease of use.",
    category: "Backend",
    type: "Rust Library",
    skills: ["Rust", "Proxy Server", "Internet Security"],
    link: "https://github.com/JeninSutradhar/Fortifynet-proxy",
  ...
  },
  {
    id: 5,
    title: "Kryptos",
    description: "Secure Password Wallet: Password manager built with Go and Fyne, designed to provide a secure and intuitive way to store and manage your passwords locally.",
    category: "Desktop",
    type: "Go App",
    skills: ["Go", "Fyne UI", "Cryptography"],
